...
AddEventHandler('esx:playerLoaded', function(xPlayer)
	if Config.UsePrivateCarGarages == true then
		ESX.TriggerServerCallback('supreme_garage:getOwnedProperties', function(properties)
...
function ListOwnedCarsMenu()
	...
	ESX.TriggerServerCallback('supreme_garage:getOwnedCars', function(ownedCars)
		if #ownedCars == 0 then
...
function ListOwnedBoatsMenu()
	...
	ESX.TriggerServerCallback('supreme_garage:getOwnedBoats', function(ownedBoats)
...
function ListOwnedAircraftsMenu()
	...
	ESX.TriggerServerCallback('supreme_garage:getOwnedAircrafts', function(ownedAircrafts)
...
function StoreOwnedCarsMenu()
	...
	if IsPedInAnyVehicle(playerPed,  false) then
		...
		ESX.TriggerServerCallback('supreme_garage:storeVehicle', function(valid)
			if valid then
...
function ReturnOwnedCarsMenu()
	ESX.TriggerServerCallback('supreme_garage:getOutOwnedCars', function(ownedCars)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'return_owned_car', {
			...
			ESX.TriggerServerCallback('supreme_garage:checkMoneyCars', function(hasEnoughMoney)
				if hasEnoughMoney then
					TriggerServerEvent('supreme_garage:payCar')
...
function ReturnOwnedBoatsMenu()
	ESX.TriggerServerCallback('supreme_garage:getOutOwnedBoats', function(ownedBoats)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'return_owned_boat', {
			...
			ESX.TriggerServerCallback('supreme_garage:checkMoneyBoats', function(hasEnoughMoney)
				if hasEnoughMoney then
					TriggerServerEvent('supreme_garage:payBoat')
					SpawnPoundedVehicle(data.current.value, data.current.value.plate)
				else
					ESX.ShowNotification(_U('not_enough_money'))
				end
...
function ReturnOwnedAircraftsMenu()
	ESX.TriggerServerCallback('supreme_garage:getOutOwnedAircrafts', function(ownedAircrafts)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'return_owned_aircraft', {
			...
			ESX.TriggerServerCallback('supreme_garage:checkMoneyAircrafts', function(hasEnoughMoney)
				if hasEnoughMoney then
					TriggerServerEvent('supreme_garage:payAircraft')
					SpawnPoundedVehicle(data.current.value, data.current.value.plate)
				else
					ESX.ShowNotification(_U('not_enough_money'))
				end
...
function ReturnOwnedPolicingMenu()
	ESX.TriggerServerCallback('supreme_garage:getOutOwnedPolicingCars', function(ownedPolicingCars)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'return_owned_policing', {
			...
			ESX.TriggerServerCallback('supreme_garage:checkMoneyPolicing', function(hasEnoughMoney)
				if hasEnoughMoney then
					TriggerServerEvent('supreme_garage:payPolicing')
					SpawnPoundedVehicle(data.current.value, data.current.value.plate)
				else
					ESX.ShowNotification(_U('not_enough_money'))
				end
...
function ReturnOwnedAmbulanceMenu()
	ESX.TriggerServerCallback('supreme_garage:getOutOwnedAmbulanceCars', function(ownedAmbulanceCars)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'return_owned_ambulance', {
			...
			ESX.TriggerServerCallback('supreme_garage:checkMoneyAmbulance', function(hasEnoughMoney)
				if hasEnoughMoney then
					TriggerServerEvent('supreme_garage:payAmbulance')
					SpawnPoundedVehicle(data.current.value, data.current.value.plate)
				else
					ESX.ShowNotification(_U('not_enough_money'))
				end
...
function RepairVehicle(apprasial, vehicle, vehicleProps)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'delete_menu', {
		...
		if data.current.value == 'yes' then
			TriggerServerEvent('supreme_garage:payhealth', apprasial)
...
function StoreVehicle(vehicle, vehicleProps)
	...
	TriggerServerEvent('supreme_garage:setVehicleState', vehicleProps.plate, true)
...
function SpawnVehicle(vehicle, plate)
	...
	TriggerServerEvent('supreme_garage:setVehicleState', plate, false)
end
...
-- Entered Marker
AddEventHandler('supreme_garage:hasEnteredMarker', function(zone)
	if zone == 'boat_garage_point' then
...
-- Exited Marker
AddEventHandler('supreme_garage:hasExitedMarker', function()
	ESX.UI.Menu.CloseAll()
	CurrentAction = nil
end)
...
Citizen.CreateThread(function()
	...
	while true do
		...
		if isInMarker and not hasAlreadyEnteredMarker then
			...
			TriggerEvent('supreme_garage:hasEnteredMarker', currentZone)
		end
		
		if not isInMarker and hasAlreadyEnteredMarker then
			hasAlreadyEnteredMarker = false
			TriggerEvent('supreme_garage:hasExitedMarker', LastZone)
		end
...
exports["np-target"]:AddCircleZone("GarageLSDock", vector3(-735.87, -1325.08, 0.6), 1.35, {
    ...
    useZ=true,
        ...
        options = {
            {
                event = "supreme_garage:OpenBoatMenu",
                icon = "fas fa-car",
                label = "Get Boat",
            },
        },
...
exports["np-target"]:AddCircleZone("GarageLSAirport", vector3(-994.59, -2946.56, 12.96), 1.35, {
    ...
    useZ=true,
        ...
        options = {
            {
                event = "supreme_garage:OpenAircraftMenu",
                icon = "fas fa-car",
                label = "Get Plane/Helicopter",
            },
        },
        distance = 10.5
    })
...
RegisterNetEvent("supreme_garage:OpenMenu")
AddEventHandler("supreme_garage:OpenMenu", function()
ListOwnedCarsMenu()
end)
-------------------
RegisterNetEvent("supreme_garage:OpenBoatMenu")
AddEventHandler("supreme_garage:OpenBoatMenu", function()
ListOwnedBoatsMenu()
end)
-------------------
RegisterNetEvent("supreme_garage:OpenAircraftMenu")
AddEventHandler("supreme_garage:OpenAircraftMenu", function()
ListOwnedAircraftsMenu()
end)