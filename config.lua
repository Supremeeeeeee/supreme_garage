...
Config.CarGarages = {
	Garage_CentralLS = {
		...
		DeletePoint = { x = 231.17, y = -802.19, z = 29.53 }
	},
	Garage_Sandy = {
	...
	Garage_LSPD = {
		GaragePoint = { x = 449.61, y = -1008.94, z = 26.94 },
		SpawnPoint = { x = 441.04, y = -1021.59, z = 28.59, h = 274.8 },
		DeletePoint = { x = 441.04, y = -1021.59, z = 26.94 } -- z = 44.67
	},
	Garage_RaceTrack = {
	...
	Garage_CabCo = {
		GaragePoint = { x = -1543.06, y = -575.0, z = 24.71 },
		SpawnPoint = { x = -1550.84, y = -576.87, z = 24.71, h = 144.86 },
		DeletePoint = { x = -1550.84, y = -576.87, z = 24.71 }
	},
	Garage_LegionUG = {
		GaragePoint = { x = 211.82, y = -935.26, z = 23.28 },
		SpawnPoint = { x = 215.84, y = -938.3, z = 23.14, h = 144.86 },
		DeletePoint = { x = 215.84, y = -938.3, z = 23.14 }
	},
	Garage_Hardware = {
		GaragePoint = { x = -3143.68, y = 1056.28, z = 19.50 },
		SpawnPoint = { x = -3148.58, y = 1076.7, z = 19.01, h = 144.86 },
		DeletePoint = { x = -3148.58, y = 1076.7, z = 19.01 }
	}
}

Config.CarPounds = {
	Pound_LosSantos = {
		PoundPoint = { x = 441.96, y = -1014.54, z = 27.20 },
		SpawnPoint = { x = 441.04, y = -1021.59, z = 28.59, h = 229.54 }
	}
}
...
Config.AircraftGarages = {
	Garage_LSAirport = {
		GaragePoint = { x = -994.59, y = -2946.56, z = 12.96 },
		SpawnPoint = { x = -999.42, y = -2990.95, z = 12.95, h = 144.86 },
		DeletePoint = { x = -999.42, y = -2990.95, z = 12.95 }
	},
	Garage_SandyAirport = {
