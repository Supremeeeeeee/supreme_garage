...
function ParkVehicles()
	MySQL.Async.execute('UPDATE owned_vehicles SET `stored` = true WHERE `stored` = @stored', {
		...
		if rowsChanged > 0 then
			print(('supreme_garage: %s vehicle(s) have been stored!'):format(rowsChanged))
		end
	end)
end

-- Get Owned Properties
ESX.RegisterServerCallback('supreme_garage:getOwnedProperties', function(source, cb)
...
ESX.RegisterServerCallback('supreme_garage:getOwnedAircrafts', function(source, cb)
...
-- Fetch Owned Boats
ESX.RegisterServerCallback('supreme_garage:getOwnedBoats', function(source, cb)
	local ownedBoats = {}
...
-- Fetch Owned Cars
ESX.RegisterServerCallback('supreme_garage:getOwnedCars', function(source, cb)
	local ownedCars = {}
...
-- Store Vehicles
ESX.RegisterServerCallback('supreme_garage:storeVehicle', function (source, cb, vehicleProps)
	local ownedCars = {}
		...
		if result[1] ~= nil then
			...
			if originalvehprops.model == vehiclemodel then
				MySQL.Async.execute('UPDATE owned_vehicles SET vehicle = @vehicle WHERE owner = @owner AND plate = @plate', {
					...
					if rowsChanged == 0 then
						print(('supreme_garage: %s attempted to store an vehicle they don\'t own!'):format(GetPlayerIdentifiers(source)[1]))
					end
					cb(true)
				end)
			else
				if Config.KickPossibleCheaters == true then
					if Config.UseCustomKickMessage == true then
						print(('supreme_garage: %s attempted to Cheat! Tried Storing: '..vehiclemodel..'. Original Vehicle: '..originalvehprops.model):format(GetPlayerIdentifiers(source)[1]))
...
ESX.RegisterServerCallback('supreme_garage:getOutOwnedAircrafts', function(source, cb)
	local ownedAircrafts = {}
...
-- Fetch Pounded Boats
ESX.RegisterServerCallback('supreme_garage:getOutOwnedBoats', function(source, cb)
	local ownedBoats = {}
...
-- Fetch Pounded Cars
ESX.RegisterServerCallback('supreme_garage:getOutOwnedCars', function(source, cb)
	local ownedCars = {}
...
ESX.RegisterServerCallback('supreme_garage:getOutOwnedPolicingCars', function(source, cb)
...
ESX.RegisterServerCallback('supreme_garage:getOutOwnedAmbulanceCars', function(source, cb)
...
ESX.RegisterServerCallback('supreme_garage:checkMoneyAircrafts', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('supreme_garage:checkMoneyBoats', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('supreme_garage:checkMoneyCars', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('supreme_garage:checkMoneyPolicing', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('supreme_garage:checkMoneyAmbulance', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('supreme_garage:payAircraft')
AddEventHandler('supreme_garage:payAircraft', function()
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('supreme_garage:payBoat')
AddEventHandler('supreme_garage:payBoat', function()
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('supreme_garage:payCar')
AddEventHandler('supreme_garage:payCar', function()
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('supreme_garage:payPolicing')
AddEventHandler('supreme_garage:payPolicing', function()
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('supreme_garage:payAmbulance')
AddEventHandler('supreme_garage:payAmbulance', function()
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('supreme_garage:payhealth')
AddEventHandler('supreme_garage:payhealth', function(price)
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('supreme_garage:setVehicleState')
AddEventHandler('supreme_garage:setVehicleState', function(plate, state)
	local xPlayer = ESX.GetPlayerFromId(source)
	...
	MySQL.Async.execute('UPDATE owned_vehicles SET `stored` = @stored WHERE plate = @plate', {
		...
		if rowsChanged == 0 then
			print(('supreme_garage: %s exploited the garage!'):format(xPlayer.identifier))
		end
	end)
end)
